The first thing to do after loading the code is to modify your version of the config file (FirTree/scripts/bin/env.config). It should point to your copies of TreeExtra binaries and rnd_tv_dta. 
