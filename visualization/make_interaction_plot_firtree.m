...
function make_interaction_plot_firtree(xvalues, xcounts, yvalues, ycounts, values, density, xlabelstr, plot_title, legendtxt = [])

clf
hold on
lw_scale = 2/numel(yvalues);
lw_offset = 2;
lc_scale = [-255 0 255]/255/numel(yvalues);
lc_offset = [1 0 0];
ly = {'-' '--' ':' '-.'};
